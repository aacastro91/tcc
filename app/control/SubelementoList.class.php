...
/**
 * SubelementoList Listing
 * @author  Anderson
 */

class SubelementoList extends TPage
{
    ...
    function onSearch()
    {
        ...
        TSession::setValue('SubelementoList_filter_descricao',   NULL);

        if (isset($data->descricao) AND ($data->descricao)) {
            $filter = new TFilter('descricao', 'like', "%{$data->descricao}%"); // create the filter
            TSession::setValue('SubelementoList_filter_descricao',   $filter); // stores the filter in the session
        }
        ...
        TSession::setValue('Subelemento_filter_data', $data);
    ...
    function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Subelemento
            ...
            if (TSession::getValue('SubelementoList_filter_descricao')) {
                $criteria->add(TSession::getValue('SubelementoList_filter_descricao')); // add the session filter
            }
